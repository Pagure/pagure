...
def api_pull_request_views(repo, username=None):
    ...
    +================+===========+===============+================================================================================+
    | ``status``     | boolean   | Optional      | Filter the status of pull requests. Default: ``True`` (opened pull requests)   |
    +----------------+-----------+---------------+--------------------------------------------------------------------------------+
    | ``assignee``   | string    | Optional      | Filter the assignee of pull requests                                           |
    +----------------+-----------+---------------+--------------------------------------------------------------------------------+
    | ``author``     | string    | Optional      | Filter the author of pull requests                                             |
    +----------------+-----------+---------------+--------------------------------------------------------------------------------+
...
def api_pull_request_add_comment(repo, requestid, username=None):
    ...
    | Key            | Type     | Optionality   | Description                                                                |
    +================+==========+===============+============================================================================+
    | ``comment``    | string   | Mandatory     | The comment to add to the pull request                                     |
    +----------------+----------+---------------+----------------------------------------------------------------------------+
    | ``commit``     | string   | Optional      | The hash of the specific commit you wish to comment on                     |
    +----------------+----------+---------------+----------------------------------------------------------------------------+
    | ``filename``   | string   | Optional      | The filename of the specific file you wish to comment on                   |
    +----------------+----------+---------------+----------------------------------------------------------------------------+
    | ``row``        | int      | Optional      | Used in combination with filename to comment on a specific row of a file   |
    +----------------+----------+---------------+----------------------------------------------------------------------------+
...
def api_pull_request_add_flag(repo, requestid, username=None):
    ...
    | Key            | Type     | Optionality   | Description                                                                                                                                                                                                                                              |
    +================+==========+===============+==========================================================================================================================================================================================================================================================+
    | ``username``   | string   | Mandatory     | The name of the application to be presented to users on the pull request page                                                                                                                                                                            |
    +----------------+----------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ``percent``    | int      | Mandatory     | A percentage of completion compared to the goal. The percentage also determine the background color of the flag on the pull-request page                                                                                                                 |
    +----------------+----------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ``comment``    | string   | Mandatory     | A short message summarizing the presented results                                                                                                                                                                                                        |
    +----------------+----------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ``url``        | string   | Mandatory     | A URL to the result of this flag                                                                                                                                                                                                                         |
    +----------------+----------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ``uid``        | string   | Optional      | A unique identifier used to identify a flag on a pull-request. If the provided UID matches an existing one, then the API call will update the existing one rather than create a new one. Maximum Length: 32 characters. Default: an auto generated UID   |
    +----------------+----------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ``commit``     | string   | Optional      | The hash of the commit you use                                                                                                                                                                                                                           |
    +----------------+----------+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
