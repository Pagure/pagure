...
def api_users():
    ...
    +===============+==========+===============+=================================================+
    | ``pattern``   | string   | Optional      | Filters the starting letters of the usernames   |
    +---------------+----------+---------------+-------------------------------------------------+
...
def api_project_tags(repo, username=None):
    ...
    | Key           | Type     | Optionality   | Description                                |
    +===============+==========+===============+============================================+
    | ``pattern``   | string   | Optional      | Filters the starting letters of the tags   |
    +---------------+----------+---------------+--------------------------------------------+
...
def api_groups():
    ...
    | Key           | Type     | Optionality   | Description                                       |
    +===============+==========+===============+===================================================+
    | ``pattern``   | string   | Optional      | Filters the starting letters of the group names   |
    +---------------+----------+---------------+---------------------------------------------------+
