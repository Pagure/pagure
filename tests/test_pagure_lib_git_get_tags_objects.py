...
class PagureLibGitGetTagstests(tests.Modeltests):
    ...
    def test_get_git_tags_objects(self):
        ...
        exp = ['0.1.0', '0.0.21', '0.0.12', '0.0.11', '0.0.3', '0.0.2',
               '0.0.1']
        add_repo_tag(repo, exp)
        tags = pagure.lib.git.get_git_tags_objects(project)
        self.assertEqual(exp, get_tag_name(tags))

        # Case 3 Sorting with alphas and betas
        exp = ['0.1.0', '0.0.21', '0.0.12-beta', '0.0.12-alpha', '0.0.12',
               '0.0.11', '0.0.3', '0.0.2', '0.0.1']
        add_repo_tag(repo, ['0.0.12-beta', '0.0.12-alpha'])
        tags = pagure.lib.git.get_git_tags_objects(project)
        self.assertEqual(exp, get_tag_name(tags))
        ...
        exp = ['15.1-0_0', '1.0-0_14', '1.0-0_2', '1.0-0_1', '0.1-1_0',
               '0.1-0_0', '0.0-2_0', '0.0-1_34', '0.0-1_11', '0.0-1_3',
               '0.0-1_2', '0.0-1_1']
        add_repo_tag(repo, exp)
